package com.sooin.basic.filter;
...
import com.sooin.basic.provider.JwtProvider;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  // description: OncePerRequestFilter 추상 클래스의 추상 메서드 구현 //
  ...
  private String parseBearerToken(HttpServletRequest request) {
    ...
    // description: Authorization 값이 Bearer Token인지 검증 //
